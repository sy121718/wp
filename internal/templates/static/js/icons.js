/**
 * icons.js — 内置图标表（与 Go core/icons.go 同名同源，检查器视觉化选择用）。
 * 全局命名空间 window.WPIcons：{ names: [...], svg(name) }
 */
(function () {
    'use strict';
    var ICONS = {
        ...
        cross: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>',
    ...
    window.WPIcons = {
        ...
        label: function (name) {
            var labels = { check: '对勾', star: '星形', arrow: '箭头', cross: '叉形', shield: '盾牌', truck: '卡车', heart: '爱心', bolt: '闪电', gift: '礼物', refresh: '循环', clock: '时钟', mail: '邮件', phone: '电话', 'map-pin': '定位', user: '用户' };
